...
public partial class Volunteers_Search : System.Web.UI.Page
{
    ...
    private void Search()
    {
        ...
        {
            case "2": SearchAll(name, phone, birthYear, mobile, idNo, email, bloodType, mobileNetwork, territory, platelet, evaluation, gender, FavPlaceID, Holded, Inactive, VolunteerID, from, To, branch, FavoriteTypeID); break;
            case "1": SearchActive(name, phone, birthYear, mobile, idNo, email, bloodType, mobileNetwork, territory, platelet, evaluation, gender, FavPlaceID, Holded, Inactive, VolunteerID, from, To, branch, FavoriteTypeID); break;
            case "0": SearchInActive(name, phone, birthYear, mobile, idNo, email, bloodType, mobileNetwork, territory, platelet, evaluation, gender, FavPlaceID, Holded, Inactive, VolunteerID, from, To, branch, FavoriteTypeID); break;
            default:
                break;
        }
    }
    ...
    private void SearchActive(string name, string phone, string birthYear, string mobile, string idNo, string email, string bloodType, string mobileNetwork, int territory, string platelet, string evaluation, string gender, int FavPlaceID, string Holded, bool Inactive, int VolunteerID, DateTime? From, DateTime? To, int BranchID, int FavoriteTypeID)
    {
        ...
        GridView1.DataSource = b.ActiveSearchVolunteer(idNo, name, phone, mobile, email, bloodType, territory, null, gender, mobileNetwork, birthYear, evaluation, platelet, null, FavPlaceID, Holded, Inactive, VolunteerID, From, To, BranchID, FavoriteTypeID);
        GridView1.DataBind();
    }
