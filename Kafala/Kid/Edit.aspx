<%@ Page Title="" Language="C#" MasterPageFile="~/Kafala/MasterPage.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Kafala_Kid_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <table dir="rtl" align="right">
        <tr>
            ...
            <td colspan="6" style="font-family: tahoma; font-size: x-large; color: #991821; font-weight: 100; text-align: center;">تعديل طفل
            </td>
            <td>&nbsp;
            </td>
            <td>&nbsp;
        ...
        <tr>
            ...
            <td>
                <radCln:RadDatePicker ID="dt_BirthDate" Runat="server" Culture="ar-EG" />
                <asp:Label ID="lbl_Date" runat="server" ForeColor="Red" Text="يجب اختيار تاريخ الميلاد" Visible="False"></asp:Label>
            </td>
            <td class="style4">&nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ControlToValidate="Txt_Kid_Mobile1"
                    Display="Dynamic" ErrorMessage="رقم الموبيل يجب أن يكون 11 أرقام" Font-Names="Tahoma"
        ...
        <tr>
            ...
            <td class="style4">
                ...
                <asp:Image ID="Image10" runat="server" Height="25px" ImageUrl="~/Kafala/Kid/w.png" Width="25px" />
                </td>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server"
                    ControlToValidate="Txt_Father1_Mobile" Display="Dynamic" ErrorMessage="رقم الموبيل يجب أن يكون 11 أرقام"
            ...
            <td class="style4">
                ...
                <asp:Image ID="Image9" runat="server" Height="25px" ImageUrl="~/Kafala/Kid/w.png" Width="25px" />
                </td>
        ...
        <tr>
            ...
            <td class="style4">
                ...
                <asp:Image ID="Image4" runat="server" Height="25px" ImageUrl="~/Kafala/Kid/w.png" Width="25px" />
                </td>
        ...
        <tr>
            ...
            <td class="style4">
                ...
                <asp:Image ID="Image7" runat="server" Height="25px" ImageUrl="~/Kafala/Kid/w.png" Width="25px" />
                </td>
        ...
        <tr>
            ...
            <td class="style4">
                ...
                <asp:Image ID="Image8" runat="server" Height="25px" ImageUrl="~/Kafala/Kid/w.png" Width="25px" />
                </td>
            <td colspan="2">
        ...
        <tr>
            ...
            <td style="text-align: left">
                <asp:Button ID="btn_Help" runat="server" OnClick="btn_Help_Click" Text="مساعدات" BorderStyle="Solid"
                    Font-Bold="True" Font-Names="Tahoma" Height="24px" Width="91px" CausesValidation="False" />
                &nbsp;
            </td>
            <td class="style4">
